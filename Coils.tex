...
\draw[->,>=stealth,color = red] (1,0) arc [start angle=-180, end angle=180,x radius=1, y radius=0.25];
\draw[->,>=stealth,color = red] (0.5,0) arc [start angle=-180, end angle=180,x radius=1.5, y radius=0.375];
